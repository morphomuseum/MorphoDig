...
void mqMorphoDigCore::OpenRawVolume(QString fileName, int dataType, int dimX, int dimY, int dimZ, double headerSize, double voxelSizeX, double voxelSizeY, double voxelSizeZ, bool bigEndian, bool frontToBack)
{
	int file_exists = 1;
	QFile file(fileName);
	QString name = "";
