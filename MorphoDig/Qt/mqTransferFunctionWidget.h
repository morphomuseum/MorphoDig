...
========================================================================*/
#ifndef mqTransferFunctionWidget_h
#define mqTransferFunctionWidget_h
...
/**
* mqTransferFunctionWidget, heavily copied from mqTransferFunctionWidget, provides a widget that can edit the control points

*/
class mqTransferFunctionWidget : public QWidget
{
  Q_OBJECT
  typedef QWidget Superclass;

public:
  mqTransferFunctionWidget(QWidget* parent = 0);
  ~mqTransferFunctionWidget() override;
...
private:
  Q_DISABLE_COPY(mqTransferFunctionWidget)
