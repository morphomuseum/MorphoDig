...
void mqScreenshotDialog::Screenshot()
{
	cout << "Screenshot dialog" << endl;
		...
		mqMorphoDigCore::instance()->Screenshot(this->m_fileName, this->Ui->magnificationX->value(), this->Ui->magnificationY->value(), this->Ui->RGB->isChecked(), this->Ui->front->isChecked());
