...
vtkStandardNewMacro(vtkMDLassoInteractorStyle);
...
vtkMDLassoInteractorStyle::vtkMDLassoInteractorStyle()
{
...
void vtkMDLassoInteractorStyle::SetActorCollection(vtkSmartPointer<vtkMDActorCollection> ActColl)
{
	this->ActorCollection = ActColl;
}
void vtkMDLassoInteractorStyle::SetNormalLandmarkCollection(vtkSmartPointer<vtkLMActorCollection> LmkColl)
{
	this->NormalLandmarkCollection = LmkColl;
}
void vtkMDLassoInteractorStyle::SetTargetLandmarkCollection(vtkSmartPointer<vtkLMActorCollection> LmkColl)
{
	this->TargetLandmarkCollection = LmkColl;
}
void vtkMDLassoInteractorStyle::SetNodeLandmarkCollection(vtkSmartPointer<vtkLMActorCollection> LmkColl)
{
	this->NodeLandmarkCollection = LmkColl;
}
void vtkMDLassoInteractorStyle::SetHandleLandmarkCollection(vtkSmartPointer<vtkLMActorCollection> LmkColl)
{
	this->HandleLandmarkCollection = LmkColl;
}
void vtkMDLassoInteractorStyle::SetFlagLandmarkCollection(vtkSmartPointer<vtkLMActorCollection> LmkColl)
{
...
void vtkMDLassoInteractorStyle::EndRotate()
{
	this->EndLandmarkMovements();
	this->Superclass::EndRotate();

}
void vtkMDLassoInteractorStyle::EndSpin()
{
	this->EndLandmarkMovements();
	this->Superclass::EndSpin();

}
void vtkMDLassoInteractorStyle::EndPan()
{
	this->EndLandmarkMovements();
...
void vtkMDLassoInteractorStyle::EndLandmarkMovements(vtkLMActor *myActor)
{
...
void vtkMDLassoInteractorStyle::EndLandmarkMovements()
{
...
//--------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::StartSelect()
{
	this->CurrentMode = VTKISMD_SELECT;

}
//--------------------------------------------------------------------------
  void vtkMDLassoInteractorStyle::OnKeyPress()
  {
	// Get the keypress
  ...
  void vtkMDLassoInteractorStyle::OnKeyRelease()
  {
	  // Get the keypress
	  vtkRenderWindowInteractor *rwi = this->Interactor;
	  std::string key = rwi->GetKeySym();
...
//--------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::OnChar()
{
...
void vtkMDLassoInteractorStyle::Dolly(double factor)
{
...
void vtkMDLassoInteractorStyle::RubberStart()
{
	if (!this->Interactor)
	{
		return;
...
//--------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::OnRightButtonDown()
{
...
void vtkMDLassoInteractorStyle::ResetMoveWhat()
{
...
void vtkMDLassoInteractorStyle::OnLeftButtonDown()
{
...
void vtkMDLassoInteractorStyle::DeleteSelectedActors()
{
...
int vtkMDLassoInteractorStyle::getNumberOfSelectedActors()
{
	this->ActorCollection->InitTraversal();
	int cpt = 0;
	for (vtkIdType i = 0; i < this->ActorCollection->GetNumberOfItems(); i++)
...
void vtkMDLassoInteractorStyle::SaveSelectedActorsPositions()
{
...
//--------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::OnMouseMove()
{
  if (this->CurrentMode != VTKISMD_SELECT )
  {
	 // this->ResetMoveWhat();
...
void vtkMDLassoInteractorStyle::RubberStop()
{
	if (!this->Interactor || !this->Moving)
	{
		return;
...
void vtkMDLassoInteractorStyle::OnRightButtonUp()
{	
	if (this->CurrentMode != VTKISMD_SELECT)
	{
...
//--------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::OnLeftButtonUp()
{
	this->LM_Button = LBUTTON_UP;
  if (this->CurrentMode != VTKISMD_SELECT)
  {
...
void vtkMDLassoInteractorStyle::OnMiddleButtonDown()
{
	this->ResetMoveWhat();
...
//----------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::OnMiddleButtonUp()
{
	if (this->CurrentMode != VTKISMD_SELECT)
	{
		//this->ResetMoveWhat();
...
//--------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::RedrawRubberBand()
{
...
//--------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::Pick()
{
...
void vtkMDLassoInteractorStyle::GetCenterOfMassOfSelectedActors(double com[3])
{
	com[0] = 0;
	com[1] = 0;
	com[2] = 0;
...
double vtkMDLassoInteractorStyle::GetBoundingBoxLengthOfSelectedActors()
{
	double boundsa[6];
...
void vtkMDLassoInteractorStyle::TransformPoint(vtkMatrix4x4* matrix, double pointin[3], double pointout[3]) {
...
void vtkMDLassoInteractorStyle::RotateActors()
{
	//cout << "ROTATE! " << endl;
	if (this->CurrentRenderer == NULL 
		|| this->ActorCollection == NULL
...
//----------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::SpinActors()
{
	if (this->CurrentRenderer == NULL
		|| this->ActorCollection == NULL
		)
...
//----------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::PanActors()
{
	if (this->CurrentRenderer == NULL 
		|| this->ActorCollection == NULL)
	{
...
void vtkMDLassoInteractorStyle::ChangeAttachmentPoint(vtkMatrix4x4 *NewMat, vtkLMActor *LMActor)
{
...
//--------------------------------------------------------------------------
void vtkMDLassoInteractorStyle::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

/*void vtkMDLassoInteractorStyle::AttachmentPointTransform(double *ap, vtkProp3D *prop3D, double apt[3])
{
...
/*void vtkMDLassoInteractorStyle::AttachmentPointTransform(double* attachmentPoint, double *boxCenter,
	int numRotation,
	double **rotate,
	double *scale, 
...
void vtkMDLassoInteractorStyle::Prop3DTransform(vtkProp3D *prop3D,
	double *boxCenter,
	int numRotation,
	double **rotate,
	double *scale)
